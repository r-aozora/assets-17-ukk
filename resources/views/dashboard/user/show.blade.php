                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" id="telepon" class="form-control" value="" readonly>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="role">Role</label>
                                        <input type="text" id="role" class="form-control" value="" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        <label for="alamat">Alamat</label>
                                        <textarea class="form-control" id="alamat" style="height: 250px" readonly></textarea>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Foto Profil</label>
                                        <img src="{{ asset('images/user.png') }}" alt="" width="250" class="d-block">
                                    </div>
                                </div>
                            </div>
